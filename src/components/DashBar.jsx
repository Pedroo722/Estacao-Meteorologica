...
//             <HomeOutlined style={{ fontSize: '20px', marginRight: '10px', color: 'black' }} />
//             <a href="/" style={{ textDecoration: 'none', color: 'black', fontWeight: 'bold' }}>Inicial</a>
//           </div>
//           <div style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
//             <LineChartOutlined style={{ fontSize: '20px', marginRight: '10px', color: 'black' }} />
//             <a href="#/graphs" style={{ textDecoration: 'none', color: 'black', fontWeight: 'bold' }}>Gráficos</a>
//           </div>
//           <div style={{ display: 'flex', alignItems: 'center', cursor: 'pointer' }}>
//             <InfoCircleOutlined style={{ fontSize: '20px', marginRight: '10px', color: 'black' }} />
//             <a href="#/info" style={{ textDecoration: 'none', color: 'black', fontWeight: 'bold' }}>Informações</a>
//           </div>
